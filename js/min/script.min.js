...
function setYear(){document.getElementById("year").textContent=(new Date).getFullYear()}function playRandomBackgroundMusic(){var t=["music1.mp3","music2.mp3","music3.mp3","music4.mp3","music5.mp3"],t="https://rcxdev.com/assets/music/"+t[Math.floor(Math.random()*t.length)],e=document.getElementById("backgroundMusic");e&&(e.src=t,e.play().catch(t=>{console.log("Autoplay was prevented by the browser. User must interact with the page first.")}))}async function fetchGitHubData(){let e={"404-Page":"./assets/projects/p1.png","Queen-s-Quest":"./assets/projects/p2.png","DevOps-Showcase":"./assets/projects/p3.png","Evaluator-System":"./assets/projects/p6.png","Face-Frenzy":"./assets/projects/p4.png",chessMind:"./assets/projects/p5.png"};try{var t=await(await fetch("https://apis.byrohan.in/v1/github/repositories")).json(),a=t.filter(t=>e.hasOwnProperty(t.name));if(Array.isArray(t)){var o,n=document.getElementById("repo-container");for(o of a){var s="https://rohan3004.github.io/"+o.name,r=await(await fetch("https://apis.byrohan.in/v1/github/languages/"+o.name)).json(),i=Object.keys(r).map(t=>`<span class="language-item">${t}</span>`).join(", "),c=document.createElement("div");c.className="repo-card",c.innerHTML=`
